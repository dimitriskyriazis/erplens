// Cookie and header names for TelERP authentication. Host-scoped cookies, so they never
...
export const SESSION_COOKIE_NAME = 'telerp-session';
 ...
 */
export const SESSION_EXP_COOKIE_NAME = 'telerp-session-exp';
